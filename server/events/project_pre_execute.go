...
type ProjectPreExecutor interface {
	...
	ExecuteNoLock(ctx *CommandContext, repoDir string, project models.Project) PreExecuteResult
}
...
func (p *ProjectPreExecute) ExecuteNoLock(ctx *CommandContext, repoDir string, project models.Project) PreExecuteResult {
	...
	return PreExecuteResult{ProjectConfig: config, TerraformVersion: terraformVersion}
}
